...
def sg_entity_search(body):
    ...
    if task_id:     filters += [['entity', 'is', {'type': 'Task', 'id': task_id}]]
    ...
    if projects:
        ...
        for each_data in data:
            ...
            if task_id:
                ...
                if task:
                    if each_data.get('time_logged'):    del each_data['time_logged']
                    if each_data.get('user'):           del each_data['user']
                    if each_data.get('time_unit'):      del each_data['time_unit']
                    if each_data.get('time_note'):      del each_data['time_note']
                    if each_data.get('description'):    del each_data['description']
